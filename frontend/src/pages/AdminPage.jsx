    ...
    if (
      window.confirm(
        `Are you sure you want to delete user ${
          userToDelete?.name || userIdToDelete
              ...
              <table className="min-w-full divide-y divide-gray-200">
                <thead className="bg-linear-to-r from-indigo-50 to-purple-50">
                  <tr>
                    ...
                    <th
                      scope="col"
                      className="hidden sm:table-cell px-6 py-4 text-left text-xs font-bold text-gray-700 uppercase tracking-wider"
                    >
                      Email
                    </th>
                    <th
                ...
                <tbody className="bg-white/50 divide-y divide-gray-200">
                  {users.map((user) => (
                    ...
                    >
                        ...
                        <div className="flex items-center">
                          <div className="shrink-0 h-11 w-11">
                            <img
                              ...
                              src={
                                user.image ||
                                `https://placehold.co/44x44/E2E8F0/4A5568?text=${user.name[0]}`
                              }
                              alt={user.name}
                              onError={(e) => {
                                e.target.onerror = null;
                                e.target.src = `https://placehold.co/44x44/E2E8F0/4A5568?text=${user.name[0]}`;
                              }}
                            />
                          </div>
                          <div className="ml-4">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <span
                          className={`px-3 py-1.5 inline-flex items-center gap-1.5 text-xs leading-5 font-semibold rounded-xl shadow-sm ${
                            user.role === "admin"
