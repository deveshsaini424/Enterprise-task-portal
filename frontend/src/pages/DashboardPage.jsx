...
import { Briefcase, CheckCircle, Clock, List, Loader2, TrendingUp, Sparkles } from 'lucide-react';
...
const StatCard = ({ title, value, icon, gradient, bgColor }) => (
  <div className="bg-white/80 backdrop-blur-lg p-6 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-white/20 group hover:scale-[1.02]">
    <div className="flex items-center justify-between mb-4">
      <div className={`shrink-0 w-12 h-12 ${gradient} rounded-xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300`}>
        {icon}
      </div>
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-indigo-50 via-white to-purple-50">
      <div className="absolute inset-0 overflow-hidden pointer-events-none opacity-40">
        ...
        <div className="absolute top-1/2 left-1/2 w-96 h-96 bg-pink-300 rounded-full mix-blend-multiply filter blur-3xl animate-pulse" style={{animationDelay: '2s'}}></div>
      </div>
      ...
      <div className="relative p-4 sm:p-6 lg:p-8">
        <div className="max-w-7xl mx-auto">
          <div className="mb-8">
            ...
            <p className="text-gray-600 ml-15">Track your projects and tasks at a glance</p>
          </div>
            ...
            <div className="max-w-md mx-auto">
              {stats?.totalTasks > 0 ? (
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-600 font-medium">No task data available to display.</p>
